        ...
        <div id="align-left-sm">
            <div>
                <a href="<?php echo $root ?>">
                    ...
                    <img id="logo-with-name" src="./res/img/Quizzation.png" alt="logo-with-name" />
                </a>
            </div>
            <div id="toggleDarkMode">
                <button type="button" class="no-style-button header-button" id="dark-mode-button"
                    onclick="switchTheme()">
                    <img src="./res/img/moon.png" alt="toggle dark mode" class="icon" id="themeIcon" />
                </button>
            </div>
        </div>
        <div id="temp-middle-logo">
            <a href=<?php echo $root ?>>
                <img id="logo-middle-sm" src="./res/img/Quizzation.png" alt="logo-with-name" />
            </a>
        </div>
        <div class="menu">
        ...
        <ul>
            ...
            <li>
                <a href="<?php echo $account ?>" class="header-button" id="profile-a">
                    <img src="https://cdn-icons-png.flaticon.com/128/1144/1144760.png" alt="profile" class="icon"
                        id="profile-icon" />
                </a>
            </li>
        </ul>
